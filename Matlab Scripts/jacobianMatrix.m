function [J, f] = jacobianMatrix(x)
% [J, f] = jacobianMatrix(x):
...
% output:
% J = Jacobian matrix evaluated at roots
...
% [f1] = u(x1, x2, x3)
% evaluates function f1 at roots

% input:
% x1, x2, x3 are roots

% output:
% f1 = value of function evaluated at roots
    f1 = 3 * x1 - cos( x2*x3 ) - 0.5;
end

function [f2] = v(x1, x2, x3)
% [f2] = v(x1, x2, x3)
% evaluates function f2 at roots

% input:
% x1, x2, x3 are roots

% output:
% f2 = value of function evaluated at roots
...
% output:
% f3 = value of function evaluated at roots
